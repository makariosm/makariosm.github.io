    ...
    <Container fluid className="about-container">
      <Container className="about-section">
        ...
        <Row className="flex-row">
          <Col md="6">
            <div className="item">
              <img src="images/soccer.png" width="310" height="308" alt="Your caption" className="image" />
        ...
        <Row className="flex-row">
          <Col md="6">
            <div className="item">
              <img src="images/skiing.png" width="286" height="382" alt="Your caption" className="image" />
              <div className="text-wrap">
